    ...
    <>
      ...
      {isEmptyActivities ? (
        <p className="text-center my-5">
          No hay {selectedOption === "actividades" ? "actividades" : "comidas"}{" "}
          aún...
        </p>
      ) : (
          ...
          >
            <div className="space-y-2 relative">
              ...
              <p className="text-2xl font-bold pt-2 text-center text-stone-900">
                Detalles:{" "}
                <span className="text-lime-600">{activity.details}</span>
              </p>
            </div>
